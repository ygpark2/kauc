...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'kauc.net 해외 한인 커뮤니티';
$config['webmaster_email'] = 'ceo@kauc.net';
...
$config['recaptcha_public_key'] = '6LctY8ESAAAAACfNqM41C2uoHbbChUJVbIfNFySQ';
$config['recaptcha_private_key'] = '6LctY8ESAAAAAAuF0rblxLKhdwJ-tzYnK7aH4dT1';
