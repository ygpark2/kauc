...
Ext.fly('profile_register_btn').on('click', function(e, t) {
	...
	Ext.Ajax.request({
		method: 'POST',
		params: params,
	   	url: 'index.php/profile/register',
...
<form id="form1">
	<fieldset>
		...
		<p>
			...
			<input type="text" id="occupation" size="30" />
		</p>
		<p>
		...
		<p>
			...
			<textarea id="introduction" cols="65" rows="7"></textarea>
		</p>
		<div class="clear"></div>
		<p class="submit" style="padding-left: 450px;"><input id="profile_register_btn" type="button" value="저장" /></p>
	</fieldset>
</form>
</div>
